...
export class CustomerRepository {
    async findById(id, rmId, isAdmin) {
        const where = {
            id,
            deletedAt: null
        };
    ...
    async findProfileById(id, rmId, isAdmin) {
        const where = {
            id,
            deletedAt: null
        };
    ...
    async findTransactions(customerId, rmId, isAdmin) {
        const customerWhere = { id: customerId, deletedAt: null };
        if (!isAdmin) {
    ...
    async findInteractions(customerId, rmId, isAdmin) {
        const customerWhere = { id: customerId, deletedAt: null };
        if (!isAdmin) {
            customerWhere.rmId = rmId;
        }
    ...
    async findAllProfiles(rmId, isAdmin) {
