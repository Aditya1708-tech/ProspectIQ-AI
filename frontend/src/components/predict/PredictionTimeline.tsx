...
import { PredictionTimelineNode } from '../../services/ai-client.js';
  ...
  return (
    <div className="bg-slate-900/30 border border-white/5 rounded-3xl p-6 shadow-xl space-y-6">
      ...
      <div className="flex items-center space-x-2 pb-3 border-b border-white/5">
        ...
        <div>
          <h4 className="text-xs font-bold text-white uppercase tracking-wider">Chronological Prediction Timeline</h4>
          <span className="text-[9px] text-slate-500 block font-medium mt-0.5">Projected relationship events and recommended manager responses</span>
        </div>
      </div>
              ...
              <div className="space-y-2 bg-slate-950/20 border border-white/5 rounded-2xl p-4 hover:border-white/10 transition-colors duration-200">
                ...
                <div className="flex justify-between items-start">
                  <div className="space-y-0.5">
                    ...
                    <h5 className="text-xs font-bold text-white leading-relaxed">{node.predictedEvent}</h5>
                  </div>
                ...
                <div className="pt-2 border-t border-white/5 flex items-start space-x-1.5 mt-2 text-[10px] text-slate-300">
                  ...
                  <span className="font-semibold leading-relaxed">
                    <strong className="text-indigo-400 font-bold">Recommended workflow action:</strong> {node.expectedRMAction}
                  </span>
                </div>
              </div>
            </div>
